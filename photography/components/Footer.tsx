      ...
      <div className={`border-t ${border} py-5 px-5 flex flex-col sm:flex-row items-center justify-between gap-4`}>
        ...
        <div className="flex items-center gap-4">
          <a href="https://www.instagram.com/imadobegi/" target="_blank" rel="noopener noreferrer"
            className="text-mist hover:text-copper transition-colors" aria-label="Instagram">
          ...
          <a href="https://www.facebook.com/imad.obegi/" target="_blank" rel="noopener noreferrer"
            className="text-mist hover:text-copper transition-colors" aria-label="Facebook">
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
