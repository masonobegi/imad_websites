  ...
  return (
    <Layout>
      <Head>
        ...
        <meta property="og:image" content="https://obgillustrator.com/photos/nature/milky-way-over-joshua-tree.jpg?v=2" />
      </Head>
      ...
      <section className="relative h-[65vh] sm:h-[78vh] overflow-hidden photo-wrapper">
        ...
        <div className="absolute bottom-0 left-0 right-0 px-6 sm:px-12 pb-10 sm:pb-16">
          ...
          {siteConfig.welcomeVisible && siteConfig.welcomeText && (
            <p className="font-serif italic text-white/50 text-sm sm:text-lg leading-relaxed max-w-2xl mt-3 hidden sm:block">
      ...
      <section className="bg-canvas">
        ...
        <div className="px-6 sm:px-10 py-6 grid grid-cols-1 sm:grid-cols-2 gap-6 bg-canvas">
          {[
            {
              id: 'jazz',
              src: '/fine-art/oils/rhythms-of-leimert-park.jpg?v=2',
              title: 'Jazz Festival',
            ...
            {
              id: 'notaries',
              src: '/digital/notaries-of-the-realm.jpg?v=2',
            ...
            {
              id: 'gumbo',
              src: '/digital/green-apples-gumbo.jpg?v=2',
      ...
      {siteConfig.commissionOpen && (
        <section className="border-b border-edge px-6 sm:px-10 py-14 sm:py-20">
          <div className="max-w-lg mx-auto">
            ...
            <p className="text-mist text-sm sm:text-base mb-8 leading-relaxed">{siteConfig.commissionBody}</p>
            <Link
              href="/commissions"
...
export const getServerSideProps: GetServerSideProps = async () => {
  ...
  const heroPhoto = {
    ...heroPhotoRecord,
    src: cleanHero ? `/hero/${heroPhotoRecord.id}.jpg?v=2` : `/photos/${heroPhotoRecord.category}/${heroPhotoRecord.filename}?v=2`,
  }
  ...
  const featuredFineArt = siteConfig.featuredFineArt.map(({ id, type }) => {
    ...
    if (!work) return null
    return { id: work.id, type, imgPath: `/fine-art/${folderMap[type]}/${work.filename}?v=2`, title: work.title }
