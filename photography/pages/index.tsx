  ...
  return (
    <Layout>
      <Head>
        ...
        <meta property="og:image" content="https://obgillustrator.com/photos/nature/milky-way-over-joshua-tree.jpg?v=3" />
      </Head>
...
export const getServerSideProps: GetServerSideProps = async () => {
  ...
  const heroPhoto = {
    ...heroPhotoRecord,
    src: cleanHero ? `/hero/${heroPhotoRecord.id}.jpg?v=3` : `/photos/${heroPhotoRecord.category}/${heroPhotoRecord.filename}?v=3`,
  }
  ...
  const featuredFineArt = siteConfig.featuredFineArt.map(({ id, type }) => {
    ...
    if (!work) return null
    return { id: work.id, type, imgPath: `/fine-art/${folderMap[type]}/${work.filename}?v=3`, title: work.title }
