  ...
  return (
    <Layout>
      <div className="max-w-2xl mx-auto px-5 py-20 sm:py-28 text-center">
        <p className="text-xs text-copper uppercase tracking-widest mb-4">Fine Art</p>
        ...
        <p className="text-mist leading-relaxed mb-3 max-w-sm mx-auto">
          Imad's paintings — oil on canvas and encaustic wax works — will be available here soon.
        </p>
