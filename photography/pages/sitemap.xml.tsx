...
const STATIC_PAGES = [
  ...
  { url: '/fine-art/watercolors?v=2', priority: '0.8' },
  { url: '/fine-art/encaustics?v=2', priority: '0.8' },
  { url: '/fine-art/oils?v=2', priority: '0.8' },
  { url: '/stickers', priority: '0.7' },
  { url: '/about', priority: '0.6' },
  { url: '/contact', priority: '0.6' },
  { url: '/commissions', priority: '0.7' },
  { url: '/photos/nature?v=2', priority: '0.8' },
  { url: '/photos/san-francisco?v=2', priority: '0.8' },
...
export const getServerSideProps: GetServerSideProps = async ({ res }) => {
  ...
  const photoUrls = photos.map(p => ({ url: `/photos/${p.category}/${p.id}?v=2`, priority: '0.7' }))
